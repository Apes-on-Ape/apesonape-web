...
/** Wallets this Ape may manage: profile wallet plus session wallets not owned by another profile. */
export async function allowedWallets(userId: string, connected: string[]) {
